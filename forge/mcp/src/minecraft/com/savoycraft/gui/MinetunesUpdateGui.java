...
import com.savoycraft.update.FileUpdaterListener;
import com.savoycraft.update.ModUpdater;
import com.savoycraft.update.UpdateEventLevel;
...
public class MinetunesUpdateGui extends GuiScreen implements
	...
	public void drawScreen(int par1, int par2, float par3) {
		...
		drawString(fontRenderer, "MineTunes Version "
				+ TDConfig.CURRENT_VERSION, 0, 0, 0x444444);
			...
			if (Minetunes.forgeMode && isInstalledFromModsFolder) {
				...
				File destFile = new File(modsFolder, "MineTunes-"
						+ autoUpdater.getLatestVersion(
								TDConfig.MC_CURRENT_VERSION).replace(
								'.', '_') + "-MC"
						+ TDConfig.MC_CURRENT_VERSION.replace('.', '_')
						+ ".zip");
