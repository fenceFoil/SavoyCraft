 ...
 * 
 */
package com.savoycraft.client;

import com.savoycraft.CommonProxy;
...
public class ClientProxy extends CommonProxy {
	...
	public void registerTickHandlers() {
		TickRegistry.registerScheduledTickHandler(SavoyCraft.instance,
				Side.CLIENT);
		TickRegistry.registerScheduledTickHandler(SavoyCraft.getConductor(),
				Side.CLIENT);
	}
