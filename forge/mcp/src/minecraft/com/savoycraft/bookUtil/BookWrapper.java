 ...
 * 
 */
package com.savoycraft.bookUtil;
 ...
 * <br>
 * A BookWrapper is also a BookSource, one book long.<br>
 * @version Minetunes 3.1.03
 */
public class BookWrapper implements BookSource {
	...
	// this version of MC
	static {
		if (TDConfig.MC_CURRENT_VERSION.equalsIgnoreCase("1.4.6")) {
			// All is right
			usePageLengthValidatorVersion = 1;
		} else if (TDConfig.MC_CURRENT_VERSION.startsWith("1.5")) {
